...
public class DistanceBeaconActivity extends Activity {
  ...
  private static final double RELATIVE_STOP_POS = 885.0 / 1110.0;// AQUI ES DONDE TIENES QUE ENREDAR PARA SABER LA DISTANCIA AL BICHO
  ...
  //@Override
  protected void onCreateeeee(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    ...
    // Here is where the range is configured based on beacon info
...
//  }
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_settings:
			Intent i = new Intent(DistanceBeaconActivity.this,
					BeaconEditorActivity.class);
			startActivity(i);
			break;
		}
		return true;
  ...
  public void onEnterAttractLayer(View v) {

          LayoutInflater li = LayoutInflater.from(this);
          View promptsView = li.inflate(R.layout.layer_prompt, null);
          AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
          alertDialogBuilder.setView(promptsView);

          TextView tvPrompt = (TextView) promptsView
                          .findViewById(R.id.textViewLayerPrompt);
          tvPrompt.setText("ATTRACT LAYER content from webservice");
          final EditText userInput = (EditText) promptsView
                          .findViewById(R.id.editTextLayerPrompt);
