 ...
 */
public class SmartPoster implements IParsedNdefRecord {
    ...
    public static SmartPoster parse(NdefRecord[] recordsRaw) {
        try {
            Iterable<IParsedNdefRecord> records = NdefMessageParser.getRecords(recordsRaw);
