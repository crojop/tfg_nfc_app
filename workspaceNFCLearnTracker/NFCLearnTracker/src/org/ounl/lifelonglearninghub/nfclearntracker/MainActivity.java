...
import org.ounl.lifelonglearninghub.nfclearntracker.db.CreateGoalActivity;
...
import org.ounl.lifelonglearninghub.nfclearntracker.fcube.MainCubeActivity;
import org.ounl.lifelonglearninghub.nfclearntracker.fcube.commands.FCOff;
import org.ounl.lifelonglearninghub.nfclearntracker.fcube.commands.FCOn;
...
import org.ounl.lifelonglearninghub.nfclearntracker.nfcrecord.IParsedNdefRecord;
import org.ounl.lifelonglearninghub.nfclearntracker.nfcrecord.NdefMessageParser;
import org.ounl.lifelonglearninghub.nfclearntracker.swipe.SwipeActivity;
import org.ounl.lifelonglearninghub.nfclearntracker.scheduler.SampleAlarmReceiver;
...
//    			intent.putExtra(
//    					org.ounl.lifelonglearninghub.nfclearntracker.db.tables.Tag.KEY_ID_TAG,
//    					record.getId());
...
//                alarm.cancelAlarm(this);
	...
	void processNdefMessageArray(NdefMessage[] msgs) {
		...
		// Check whether this tag is already mappeed to a goal
		if (sGoalId.length() < 1) {
