...
public class Goal implements ITables{
	...
	public void loadUpdatedValues(ContentValues cv, String mins) {
		
		Long ol = new Long(mins);
		long newDailytTimeMills = ol.longValue() * 1000 * 60;
		
		 cv.put(KEY_NAME, getsName());
		 cv.put(KEY_DESC, getsDesc());
		 cv.put(KEY_DAILY_TIME, newDailytTimeMills);
