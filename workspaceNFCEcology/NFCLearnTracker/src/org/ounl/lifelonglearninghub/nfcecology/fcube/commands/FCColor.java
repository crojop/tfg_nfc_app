...
public class FCColor implements IFeedbackCubeCommnads{
	...
	public FCColor(String sIp, String sRGBHEX){
		...
		System.out.println(sRGBHEX);
		String sR = sRGBHEX.substring(0,2);
		System.out.println(" R"+sR);
		String sG = sRGBHEX.substring(2,4);
		System.out.println(" G"+sG);
		String sB = sRGBHEX.substring(4,6);
		System.out.println(sRGBHEX+" R"+sR+" G"+sG+" B"+sB);
