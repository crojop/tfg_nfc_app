...
import org.ounl.lifelonglearninghub.nfcecology.fcube.Constants;
...
//	public static final String ACTION_BEEP = "ACTION_BEEP";
	...
	public void initSamplers(){
		...
		addSampler(
				Constants.JB_B,
				new Sampler(
						new FCGeneric("/speaker/melody/1/", "", "PUT"),
						//new FCMelody1(FeedbackCubeConfig.getSingleInstance().getIp()),
						"B"
						)
				);		
		...
		addSampler(
				...
				new Sampler(
						...
						//new FCOff(FeedbackCubeConfig.getSingleInstance().getIp()),
						"C"
						)
				);		
		...
		addSampler(
				Constants.JB_D,
				new Sampler(
						new FCGeneric("/ring/fade/","{\"n\": 5,\"d\": 10}", "PUT"),
						"D"
						)
				);		
		...
		addSampler(
				Constants.JB_E,
				new Sampler(
						new FCGeneric("/ring/fade/","{\"n\": 10,\"d\": 1}", "PUT"),
						"E"
						)
				);		
		...
		addSampler(
				...
				new Sampler(						
						...
						//new FCRainbowCircle(FeedbackCubeConfig.getSingleInstance().getIp()),
		...
		addSampler(
				Constants.JB_I,
				new Sampler(
						new FCGeneric("/speaker/beep/","", "PUT"),
						"I"
						)
				);
		...
		addSampler(
				Constants.JB_J,
				new Sampler(						
						new FCGeneric("/ring/pixel/range/","{\"n1\": 0,\"n2\": 3, \"r\": 255,\"g\": 0,\"b\": 0}", "PUT"),
						"J"
						)
				);
