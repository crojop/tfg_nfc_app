...
public class DistanceBeaconActivity extends Activity {
        ...
        runOnUiThread(new Runnable() {
          ...
          public void run() {
            ...
            if (foundBeacon != null) {
            	...
            	Log.e(TAG, "updateDistanceView!! Major:"+foundBeacon.getMajor() + " Minor:"+foundBeacon.getMinor());
  ...
  private void updateDistanceView(Beacon foundBeacon) {
	...
	Toast.makeText(this, "updateDistanceView "+computeDotPosY(foundBeacon), Toast.LENGTH_LONG).show();
	Log.e(TAG, "updateDistanceView "+computeDotPosY(foundBeacon));
